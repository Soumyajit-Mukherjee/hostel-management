...
<head>
    ...
    <title>Auditor Dashboard - Radhakrishnan Bhawan</title>
    ...
    <style>
        ...
        :root {
            --primary-blue: #0b1c4a;
            --accent-teal: #29768a;
            --accent-gold: #cfa832; /* A slight gold accent to distinguish the Auditor role */
            --bg-color: #f0f4f8;
            --text-dark: #333;
            --text-muted: #666;
        ...
        * {
        ...
        .role-badge {
            background: rgba(207, 168, 50, 0.2);
            color: #ffd54f;
            border: 1px solid rgba(207, 168, 50, 0.5);
            padding: 4px 12px;
            border-radius: 20px;
            font-size: 12px;
            font-weight: 600;
        ...
        /* Highlight the Auditor specific card with gold */
        .auditor-task::before {
            background: linear-gradient(90deg, var(--accent-gold), #fbc02d);
        ...
        .auditor-task:hover {
            border-color: rgba(207, 168, 50, 0.5);
        }
        ...
        .auditor-task .card-icon {
            background: rgba(207, 168, 50, 0.1);
        ...
        .auditor-task:hover .card-icon {
            background: var(--accent-gold);
            box-shadow: 0 8px 20px rgba(207, 168, 50, 0.3);
        }
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-header">
            <div class="welcome-text">
                <h2>Welcome back, Boarder <span class="role-badge"><i class="fa-solid fa-calculator"></i> Auditor</span></h2>
                <p>Manage your personal hostel services and complete your committee auditing duties.</p>
            </div>
        </div>
        ...
        <div class="action-grid">
            ...
            <a href="meal_charge.jsp" class="action-card auditor-task">
                <div class="card-icon"><i class="fa-solid fa-calculator"></i></div>
                <h3>Calculate Meal Charge</h3>
                <p>Compute and process the official monthly mess and meal expenses for hostel residents.</p>
                <div class="card-footer">Start Audit <i class="fa-solid fa-arrow-right"></i></div>
            </a>
            ...
            <a href="boarders.jsp" class="action-card manager-task">

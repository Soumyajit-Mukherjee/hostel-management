...
<head>
    ...
    <title>Mess Prefect Dashboard - Radhakrishnan Bhawan</title>
    ...
    <style>
        ...
        :root {
            --primary-blue: #0b1c4a;
            --accent-teal: #29768a;
            --accent-prefect: #7e57c2; /* Royal Purple to distinguish the Prefect leadership role */
            --bg-color: #f0f4f8;
            --text-dark: #333;
            --text-muted: #666;
        ...
        * {
        ...
        /* Highlight the Prefect specific cards with purple */
        .prefect-task::before {
            background: linear-gradient(90deg, var(--accent-prefect), #5e35b1);
        ...
        .prefect-task .card-icon {
            background: rgba(126, 87, 194, 0.1);
            color: var(--accent-prefect);
        }
        ...
        .prefect-task:hover .card-icon {
            background: var(--accent-prefect);
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-header">
            <div class="welcome-text">
                <h2>Welcome back, Boarder <span class="role-badge"><i class="fa-solid fa-star"></i> Mess Prefect</span></h2>
                <p>Manage hostel appointments, view committee rosters, and access your personal boarder services.</p>
            </div>
        </div>
        ...
        <div class="action-grid">
            ...
            <a href="select_manager.jsp" class="action-card prefect-task">
                <div class="card-icon"><i class="fa-solid fa-user-plus"></i></div>
                <h3>Select Managers</h3>
                <p>Nominate and assign boarding students to official hostel management and committee roles.</p>
                <div class="card-footer">Assign Roles <i class="fa-solid fa-arrow-right"></i></div>
            </a>

            <a href="view_manager.jsp" class="action-card prefect-task">
                <div class="card-icon"><i class="fa-solid fa-clipboard-user"></i></div>
                <h3>View Managers</h3>
                <p>Access the directory of currently assigned mess managers, auditors, and committee members.</p>
                <div class="card-footer">View Roster <i class="fa-solid fa-arrow-right"></i></div>
            </a>
            ...
            <a href="boarders.jsp" class="action-card">
                <div class="card-icon"><i class="fa-solid fa-users"></i></div>
                <h3>View Boarders</h3>
                <p>Access the directory to see information about your fellow hostel residents.</p>

...
<head>
    ...
    <title>Student Dashboard - Radhakrishnan Bhawan</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            min-height: 100vh;
            /* Adjust the background image path if necessary */
        ...
        body::before {
            ...
            background: rgba(11, 28, 74, 0.75); /* Deep blue tint for focus */
            z-index: -1;
        }
        ...
        .action-card p {
            ...
            line-height: 1.5;
            margin-bottom: 20px;
            flex-grow: 1; /* Pushes the arrow down */
        }
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="welcome-header">
            <h2>Welcome back, Boarder</h2>
            <p>Access your hostel services, manage meals, and process requests from your dashboard.</p>
        </div>
        ...
        <div class="action-grid">
            ...
            <a href="meal_on_off.jsp" class="action-card">
                ...
                <h3>Meal On/Off</h3>
                <p>Manage your daily meal preferences and toggle your mess status.</p>
            ...
            <a href="meal_charge_request.jsp" class="action-card">
                ...
                <p>Submit and record your monthly mess and meal charge payments.</p>

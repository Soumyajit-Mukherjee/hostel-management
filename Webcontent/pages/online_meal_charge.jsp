...
<html>
<head>
    <title>Update Boarder's Meal Charge</title>
...
<body class="centered-bg">
    ...
    <div class="login-box" style="width: 90%; max-width: 1000px;">
        <h2 style="color: black;">Update Boarder's Meal Charge</h2>
        ...
        <%
            try {
                ...
                String sql = "SELECT * FROM boarder_meal_charge WHERE status = 'pending'";
        ...
        %>
                <tr>
                    ...
                    <td>
                        <a href="../BoarderMealChargeApprovalServlet?action=approve&username=<%= rs.getString("username") %>" class="btn-small approve">Update</a>
                        <a href="../BoarderMealChargeApprovalServlet?action=reject&username=<%= rs.getString("username") %>" class="btn-small reject">Reject</a>
                    </td>
                </tr>
        <%
                }
